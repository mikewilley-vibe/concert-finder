# Recommended first native release

The first Expo release should prove one reliable concert-discovery journey and
avoid carrying the website's long-page layout into mobile.
...
- Anonymous first use with safe conversion or transfer to a permanent account
- Email/password sign-in, sign-out, recovery, and account deletion
...
## Keep on the website for version 1.0

- Community concert submission and draft editing
...
- Current-location and radius search
